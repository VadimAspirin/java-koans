...
public class AboutCasting {
    ...
    public void longPlusInt() {
        ...
        long b = 10;
        Object c = a + b;
        assertEquals(c, 16l);//всегда тот тип данных, который длиннее
    ...
    public void forceIntTypecast() {
        ...
        int b = (int) a;
        assertEquals(b, -2147483648);//переполнение
    }
    ...
    public void upcastWithInheritance() {
        ...
        Parent parentReference = child; // Why isn't there an explicit cast? //ребенок расширяется отцом
    ...
    public void downcastWithInheritance() {
        ...
        Parent parentReference = (Parent) child; // Why do we need an explicit cast here? //сделали ребенка отцом
