...
public class AboutStrings {
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getClass(), java.util.MissingFormatArgumentException.class); // передача исключения как аргумента
            assertEquals(e.getMessage(), "Format specifier '%s'"); //ошиба формата
        }
    }
