...
public class AboutCollections {
    ...
    public void usingAQueue() {
        ...
        queue.add("Cat");
        queue.add("Dog");
        assertEquals(queue.peek(), "Cat" );//получить вверх, если его нет, то null
        assertEquals(queue.size(), 2);
        assertEquals(queue.poll(), "Cat");//удалить вверх, -> null
    ...
    public void usingABasicMap() {
        ...
        assertEquals(map.containsValue("first value"), false);//проверка и перезапись значения
